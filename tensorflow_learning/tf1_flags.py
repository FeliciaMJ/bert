...
"""
1、flags可以帮助我们通过命令行来动态的更改代码中的参数。Tensorflow 使用flags定义命令行参数的方法。ML的模型中有大量需要tuning的超参数，
    所以此方法，迎合了需要一种灵活的方式对代码某些参数进行调整的需求.
...
"""
flags = tf.flags
flags.DEFINE_string("path_data", " ", "tfRecord sava path.")
